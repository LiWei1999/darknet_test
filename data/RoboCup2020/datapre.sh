...
imgs_dir = '/home/chenyuhang/darknet/data/RoboCup2020/dataset'
print(imgs_dir)
...
file_train = open('/home/chenyuhang/darknet/data/RoboCup2020/train.txt', 'w')
file_test = open('/home/chenyuhang/darknet/data/RoboCup2020/test.txt', 'w')
