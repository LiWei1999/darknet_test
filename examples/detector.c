...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        //resize_network(net, sized.w, sized.h);
            ...
            int m = plist->size;
            if(access("/root/data/chenyuhang/darknet/data/RoboCup2020/out",0)==-1)//"/home/FENGsl/darknet/data"修改成自己的路径
            {
              if (mkdir("/root/data/chenyuhang/darknet/data/RoboCup2020/out",0777))//"/home/FENGsl/darknet/data"修改成自己的路径
               {
        ...
        if(outfile){
            save_image(im, outfile);
             ...
             char b[2048];
            sprintf(b,"/root/data/chenyuhang/darknet/data/RoboCup2020/out/%s",GetFilename(path));//"/home/FENGsl/darknet/data"修改成自己的路径
